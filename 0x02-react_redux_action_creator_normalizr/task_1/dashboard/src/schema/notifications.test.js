...
describe("getAllNotificationsByUser", () => {
  it("returns all notifications for a specific user", () => {
  ...
  it(`Verifies that our normalized data has a correct users entity`, () => {
    const expected = {
      age: 25,
  ...
  it(`Verifies that our normalized data has a correct notifications entity`, () => {
    const expected = {
